...
function get_collection_goods($user_id, $num = 10, $start = 0)
{
    $sql = 'SELECT g.goods_id, g.goods_name, g.market_price, g.shop_price AS org_price, '.
                ...
                'g.promote_price, g.promote_start_date,g.promote_end_date, c.rec_id, c.is_attention, g.goods_thumb' .
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
		...
		$goods_list[$row['goods_id']]['thumb']    = get_image_path($row['goods_id'], $row['goods_thumb']);  //qxfz.cn
    }
